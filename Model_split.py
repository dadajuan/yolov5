...
def get_mobile_cloud_model(full_model):
    ...
    class cloud_model(nn.Module):
        def __init__(self):
            ...
            self.dark2_C3 = cloud_model_dark2_C3
...
# yolov5_mobile_model
mobile, cloud = get_mobile_cloud_model(model)
mobile = mobile().cuda()
...
# test_data = torch.randn((1,3,640,640)).cuda()
# output_mobile = mobile(test_data)
# output_cloud = cloud(output_mobile)
# output = model(test_data)
# print(output[0]-output_cloud[0])
